...
# Simplified DQN model with reduced dropout and ReLU activation
class SkipPredictionDQN(nn.Module):
    def __init__(self, behavior_dim, context_dim, content_dim, hidden_dim=100, output_dim=1):
        ...
        # Dedicated layers for each feature type without batch normalization
        ...
        # Combined layer and output with reduced dropout
...
# ColdStartPredictor remains unchanged

import argparse
import torch  # Make sure to import torch to check for GPU availability

def parse_args():
    parser = argparse.ArgumentParser()

    # Add data_root as a required argument
    parser.add_argument('--data_root', required=True, type=str,
                        help='Root directory for the dataset files (containing item_map.csv, seq_new.csv, sess_map.csv)')
    ...
    # Set device based on availability of GPU, with 'cpu' as fallback
